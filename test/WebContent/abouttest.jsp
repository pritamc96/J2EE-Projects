...
<div class="w3-bar w3-black" id="myNavbar">
    ...
    <a href="login.jsp" class="w3-bar-item w3-button"><b>Log In</b></a>
  </div>
<!-- Header -->
...
<section class="w3-container w3-center w3-content" style="max-width:600px">
  ...
  <p class="w3-center"><em>CITI BANK is commercial bank with headquarters at Salt Lake Sector 5 complex, KOLKATA. Founded in 1906, it has been government-owned since nationalisation in 1969. However, some branches are individually owned, such as Kandia, Indonesia, etc. CITI BANK has 5100 branches as on 31 January 2017, including 56 offices outside India, which includes five subsidiaries, five representative offices, and one joint venture.[citation needed] CITI is a founder member of SWIFT (Society for Worldwide Inter Bank Financial Telecommunications), which facilitates provision of cost-effective financial processing and communication services.</em></p>
