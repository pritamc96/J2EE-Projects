...
<div class="container">  
  <form action="contact" method="post">
    ...
    <fieldset>
      <input placeholder="Your Email Address" type="email" tabindex="2" name="uid" required>
    </fieldset>
    <fieldset>
      <input placeholder="Your Phone Number" type="tel" tabindex="3" name="ph"required>
    </fieldset>
    <fieldset>
      <textarea placeholder="Type your Message Here...." tabindex="4" name="msg" required></textarea>
    </fieldset>
    <fieldset>
